...
export const translations: Record<Language, TranslationContent> = {
  EN: {
    ...
    footer: {
      tagline: 'Hassle-Free Scooter Rental in Labuan Bajo. Free delivery. No deposit. Locals who care.',
  ...
  ID: {
    ...
    footer: {
      tagline: 'Sewa Motor & Skuter Praktis di Labuan Bajo. Antar jemput gratis. Tanpa deposit. Pelayanan ramah lokal.',
  ...
  ZH: {
    ...
    footer: {
      tagline: '拉布安巴佐轻松便捷摩托车租赁。免费送车，无需押金，本地贴心服务。',
